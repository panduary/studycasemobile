package com.example.android.pandu_1202150009_modul1;
...
public class Review extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast toast = null;
        if(price < 65000) {
            toast = Toast.makeText(getApplicationContext(), "DISINI MURAH GAN", Toast.LENGTH_SHORT);
        }else{
            toast = Toast.makeText(getApplicationContext(), "ASTAGA MAHAL GAN", Toast.LENGTH_SHORT);
        }
        toast.show();
    }
}
